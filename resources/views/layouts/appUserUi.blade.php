...
<head>
    ...
    <style>
        * {
        ...
        body{
            background-image: url('https://img.freepik.com/premium-photo/abstract-design-background-with-blue-green-waving-lines-pattern-white-background_1123766-686.jpg?w=996'); 
...
<body ass="d-flex flex-column min-vh-100">
    <div id="app">
    <header>
